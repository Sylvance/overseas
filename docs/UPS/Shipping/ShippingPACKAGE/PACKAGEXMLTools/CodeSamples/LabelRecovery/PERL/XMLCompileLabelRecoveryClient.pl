...
$requestSchemaFile=" Add LabelRecoveryRequest Schema File";
$responseSchemaFile=" Add LabelRecoveryResponse Schema File";
...
#print $schema->template('PERL' => 'LabelRecoveryRequest');
$doc = XML::LibXML::Document->new('1.0', 'UTF-8');
$writer = $schema->compile(WRITER => 'LabelRecoveryRequest');

my $labelrecoveryrequest =  
{
	Request =>
	{
...
$xml = $writer->($doc , $labelrecoveryrequest);
$doc->setDocumentElement($xml);
push(@XML , $doc->toString());
