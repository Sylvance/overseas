/*
 **
 ** Filename: JaxbShipAcceptClient.java
...
import com.ups.xolt.codesamples.request.jaxb.ShipmentAcceptRequest;
import com.ups.xolt.codesamples.request.jaxb.TransactionReferenceType;
import com.ups.xolt.codesamples.response.jaxb.ShipmentAcceptResponse;
...
public class JaxbShipAcceptClient {
    ...
    public static void main( String[] args ) {
        ...
        try {
			...
			populateShipAcceptRequest(shipAcceptRequest);
			...
			System.out.println("Response Status Code: " + shipAcceptResponse.getResponse().getResponseStatusCode());
			System.out.println("Response Status Description: " + shipAcceptResponse.getResponse().getResponseStatusDescription());
	...
	private static void populateShipAcceptRequest(ShipmentAcceptRequest shipRequest) {
		...
		shipRequest.setShipmentDigest("test-Invalid-digest");
	}
}
